...
import com.compscieddy.plantr.ui.FontCache;

import androidx.appcompat.widget.AppCompatAutoCompleteTextView;

import static com.compscieddy.plantr.ui.FontCache.AVENIR_NEXT_REGULAR;
import static com.compscieddy.plantr.FontConstants.DEFAULT_FONT;
import static com.compscieddy.plantr.FontConstants.PREF_SELECTED_FONT;
...
public class FontAutoCompleteTextView extends AppCompatAutoCompleteTextView {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    if (typefaceId == -1) {
      ...
      SharedPreferences sharedPreferences = PlantrApplication.getSharedPreferences();
